...
# PN, PFN, PCNN, ParT
model=$1
if [[ "$model" == "ParMAT" ]]; then
    modelopts="networks/example_ParticleMultiAxisTransformer.py --use-amp"
    batchopts="--batch-size 512 --start-lr 1e-3"
elif [[ "$model" == "SWAP" ]]; then
    modelopts="networks/example_SwinParticleTransformer.py"
