import torch
from weaver.nn.model.ParticleMultiAxisTransformer import ParticleMultiAxisTransformer
...
class ParticleMultiAxisTransformerWrapper(torch.nn.Module):
    def __init__(self, **kwargs) -> None:
        super().__init__()
        self.mod = ParticleMultiAxisTransformer(**kwargs)
...
def get_model(data_config, **kwargs):
    ...
    model = ParticleMultiAxisTransformerWrapper(**cfg)
